...
If you are looking for scMnT, which is for analyzing microsatellite instability in single-cell resolution from scRNA-seq data, please refer to [scMnT GitHub page](https://github.com/18parkky/scMnT)
